...
(function (ng) {
    ...
    var mod = ng.module('taskMock', ['ngMockE2E']);
    ...
    mod.run(['$httpBackend', function ($httpBackend) {
            ...
            var records = [{
                    id: 1000,
                    name: 'Taller 1',
                    description: 'Realizar el taller 1',
                    date: '2016-02-23'
                },
                {
                    id: 1001,
                    name: 'Taller 2',
                    description: 'Realizar el taller 2',
                    date: '2016-02-26'
                }];
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/tasks"
             ...
             */
            $httpBackend.whenGET('api/tasks').respond(function (method, url) {
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/tasks/[numero]"
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud POST a la url "api/tasks"
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud DELETE a la url "api/tasks/[numero]"
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud PUT a la url "api/tasks/[numero]"
